...
const AnalyticsCards = () => {
  ...
  return (
    <div className="grid grid-cols-4 md:grid-cols-4 gap-4 mb-8 col-span-3">
      ...
      <div className="bg-green-100 p-4 rounded shadow">
        <p className="text-sm text-green-700">Average Monthly Expense</p>
      ...
      <div className="bg-red-100 p-4 rounded shadow">
        ...
        <p className="text-2xl font-bold text-red-900">you have a total of {summary.count} expense entries {user?.name || user?.email}.</p>
      </div>
    </div>
  );
};
